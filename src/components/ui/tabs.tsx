  ...
  >
    ...
    {props["data-state"] === "active" && (
        <motion.div
            ...
            className="absolute inset-0 z-0 rounded-sm bg-background shadow-sm border-border"
