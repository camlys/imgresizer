...
export const apps = [
    { name: 'ImgResizer', id: 'imgresizer', url: 'https://camly.site', icon: <img src="/imgresizer.jpeg" alt="ImgResizer" className="w-8 h-8 rounded-sm" />, description: 'The current app' },
