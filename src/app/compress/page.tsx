                            ...
                            <div className="grid md:grid-cols-2 gap-8 items-start">
                                ...
                                <Card>
                                    ...
                                    <CardContent className="space-y-4">
                                        <div className="relative rounded-lg shadow-lg overflow-hidden bg-muted flex justify-center items-center h-[400px] p-4">
                                            <div className="w-full h-full overflow-y-auto">
                                                <img src={result.jpeg.dataUrl} alt="Compressed JPEG image" className="w-full h-auto" />
                                            </div>
