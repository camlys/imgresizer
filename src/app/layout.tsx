...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    '@type': 'WebApplication',
    name: 'ImgResizer: Free Image & PDF Editor, Resizer & Converter',
    url: 'https://imgresizer.xyz',
    applicationCategory: 'MultimediaApplication',
    operatingSystem: 'All',
    description: 'Resize, crop, convert, and edit images & PDFs online for free. Our private, client-side tool works instantly in your browser. No sign-up required.',
    featureList: [
  ...
  return (
    <html lang="en" suppressHydrationWarning className={spaceGrotesk.variable}>
      <head>
        <title>ImgResizer: Free Image & PDF Editor, Resizer & Converter</title>
     ...
     crossOrigin="anonymous"></script>
        ...
        <meta name="description" content="Resize, crop, convert, and edit images & PDFs online for free. Our private, client-side tool works instantly in your browser. No sign-up required." />
        ...
        <meta name="twitter:title" content="ImgResizer: Free Image & PDF Editor, Resizer & Converter" />
        <meta name="twitter:description" content="Resize, crop, convert, and edit images & PDFs online for free. Our private, client-side tool works instantly in your browser. No sign-up required." />
        <meta name="twitter:creator" content="@ImgResizer" />
        <meta name="twitter:image" content="https://www.imgresizer.xyz/imgresizer.png" />
        <meta property="og:title" content="ImgResizer: Free Image & PDF Editor, Resizer & Converter" />
        <meta property="og:description" content="Resize, crop, convert, and edit images & PDFs online for free. Our private, client-side tool works instantly in your browser. No sign-up required." />
