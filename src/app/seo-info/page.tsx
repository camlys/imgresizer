...
export const metadata: Metadata = {
    ...
    description: 'A complete SEO-optimized guide to ImgResizer. Learn about resizing, cropping, converting (PNG, JPEG, PDF), and editing photos online for free, with total privacy. Your top-ranking solution for image editing.',
    keywords: 'image resizer, photo editor, online image editor, free photo editor, crop image, resize image, convert image format, private image editor, ImgResizer, SEO, metadata, keywords, free image editor no watermark, online photo collage maker, pdf to jpg converter online, perspective correction, photo resizer, JPG converter, image to PDF, online picture editor, photo collage maker, image compressor, change image size, edit photos online, free online photo editor, image editor online, best free photo editor, picture editor, photo editor free, edit pictures, image resizer online, resize image online, png to jpg, webp to png, image to pdf converter, secure document editing, photo editor for social media',
};
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-muted-foreground pt-2">
              This page provides a detailed, keyword-rich overview of ImgResizer to enhance search engine visibility. We are the premier destination for anyone needing a <strong className="text-primary">free, private, and powerful online image and photo editor</strong>.
            </p>
          </CardHeader>
          <CardContent className="space-y-8 text-muted-foreground">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground flex items-center"><Check className="text-primary mr-2" />Format Conversion & Compression</h3>
             ...
             <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li><strong>Social Media Managers:</strong> Quickly resize and crop images for Instagram, Facebook, Twitter, and Pinterest. The perfect <strong className="text-primary">photo editor for social media</strong>.</li>
                <li><strong>Students & Educators:</strong> Easily crop documents from photos, create collages for projects, and convert lecture slides (PDF) into images for notes.</li>
                <li><strong>Professionals & Freelancers:</strong> Securely edit sensitive documents, add watermarks to protect your work, and prepare images for presentations without worrying about privacy.</li>
