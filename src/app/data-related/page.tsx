      ...
      <main className="flex-1 container mx-auto py-12 px-6">
        <Card>
          ...
          <CardContent className="space-y-6 text-muted-foreground">
            <p>At Camly, we prioritize your privacy and data security. Our application is designed to process all your images directly on your device (client-side), which means we do not store your images on our servers.</p>
            ...
            <p>
              Given our client-side processing model, there is no personal data from your editing sessions for us to provide. Any data related to your use of Camly is stored locally in your browser's storage and is under your control. You can clear this data at any time by clearing your browser's cache and site data.
            </p>
            <p>
