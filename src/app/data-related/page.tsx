      ...
      <main className="flex-1 container mx-auto py-12 px-6">
        <Card>
          ...
          <CardContent className="space-y-6 text-muted-foreground">
            ...
            <p>For any specific questions or concerns regarding your data and our commitment to GDPR, please contact us at <a href="mailto:contact@imgresizer.xyz" className="text-primary hover:underline">contact@imgresizer.xyz</a> with the subject line "GDPR Inquiry".</p>
          </CardContent>
        </Card>
      </main>
      <SiteFooter />
